...
export default function Home() {
  return (
    <main>
      ...
      <Description />
      <Requirement />
      <h2 className="text-2xl text-center py-14 md:py-6 font-extrabold text-black dark:text-white sm:text-4xl bg-base-300">
      ...
      <div className="bg-base-300 w-full flex flex-col justify-center items-center pt-6">
        ...
        <Link href="/register-online" className="btn bg-red-700 rounded-none border-none px-8 my-6 shadow-[0_10px_50px_rgba(185,_28,_28,_0.5)] hover:bg-primary/80 hover:shadow-none">Daftar Online Disini</Link>
      </div>
      <Timeline />
      <FAQ />
    </main>
