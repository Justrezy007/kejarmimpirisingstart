        ...
        if (captcha != '') {
            ...
            try {
                ...
                if (res?.user) {
                    ...
                    if(data.city == 'manado') sendEmail(data.city,data.email,'Bumi Beringin Resto Jl. Brigjend Katamso Lrg. Lingkungan 5, Bumi Beringin, Kec. Wenang, Kota Manado, Sulawesi Utara', 'https://g.co/kgs/xAj7FcQ', 'Sabtu, 8 Juni 2024','08.00 - 17.00 WIB','#RisingStartManado','https://chat.whatsapp.com/JwBA1H8OMDnJz2VzXSuF7J')
