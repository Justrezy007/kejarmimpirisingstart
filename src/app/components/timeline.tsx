...
const   Timeline = () => {
    return (
        <ul id="timeline" className="timeline timeline-vertical pt-16">
            ...
            <li>
                <div className="timeline-start mx-8 my-8 timeline-box bg-base-200 px-8">Manado&emsp;&emsp;: 6 Mei - 14 Mei 24’<br/>Jogja &emsp;&emsp;&emsp;: 6 Mei - 27 Mei 24’<br />Jakarta &emsp;&emsp;: 6 Mei - 10 Juni 24’</div>
            ...
            <li>
                <hr />
                <div className="timeline-start my-8 mx-8 timeline-box bg-base-200 px-8">Manado&emsp;&emsp;: 1 Juni 24’<br/>Jogja &emsp;&emsp;&emsp;: 18 Mei 24’<br />Jakarta &emsp;&emsp;: 15 Juni 24’</div>
                <div className="timeline-middle">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
                </div>
            ...
            <li>
                <hr />
                <div className="timeline-end mx-8 my-8 timeline-box bg-base-200 px-8">6 Juli 24’</div>
                <div className="timeline-middle">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
                </div>
