...
const Card: React.FC<CardProps> = ({ city, img, quota, tanggal, data, place, isDisable}) => {
    return (
        <div className="w-56 bg-base-100 bg-opacity-80 backdrop-blur flex flex-col md:p-8 md:py-5 pt-5 border border-neutral md:border-opacity-50">
            ...
            {isDisable ? 
            <Link href="#" className="bg-slate-700 rounded-none border-none px-8 py-2 text-sm text-center mt-4 shadow-[0_10px_50px_rgba(185,_28,_28,_0.5)] hover:bg-primary/80 hover:shadow-none">Telah Berlangsung</Link>
            :
