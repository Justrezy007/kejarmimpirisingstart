...
const Card: React.FC<CardProps> = ({ city, img, quota, tanggal }) => {
    return (
        <div className="md:w-56 w-32 bg-base-100 bg-opacity-80 backdrop-blur flex flex-col md:p-8 py-5 border border-neutral border-opacity-50">
            ...
            <Link href="/register-offline" className="bg-red-700 rounded-none border-none px-8 py-2 text-sm text-center mt-4 shadow-[0_10px_50px_rgba(185,_28,_28,_0.5)] hover:bg-primary/80 hover:shadow-none">Daftar Disini</Link>
        </div>
    );
};
